...
public class Music2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMediaPlayer = MediaPlayer.create(Music2Activity.this, R.raw.zhong);
    ...
    private void setListener() {
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mMediaPlayer.stop();
                Intent intent = new Intent(Music2Activity.this, Music3Activity.class);
        ...
        stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mMediaPlayer.stop();
                Intent intent = new Intent(Music2Activity.this, MusicActivity.class);
                startActivity(intent);
                finish();
            }
        });
        pause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mMediaPlayer.isPlaying()) {
                    mMediaPlayer.pause();
                    Toast.makeText(Music2Activity.this,"暂停",Toast.LENGTH_SHORT).show();
                } else {
                    mMediaPlayer.start();
                    Toast.makeText(Music2Activity.this,"播放",Toast.LENGTH_SHORT).show();
                }
            }
        });
